...
export const MAP_NODES: MapNode[] = [
  { id: 'n1', x: 100, y: 100, type: 'intersection', name: '中央路口', connections: ['n2', 'n5', 'n7', 'n10'] },
  { id: 'n2', x: 250, y: 100, type: 'restaurant', name: '星光餐厅', connections: ['n1', 'n3', 'n6'] },
  { id: 'n3', x: 400, y: 100, type: 'intersection', name: '东街口', connections: ['n2', 'n4', 'n8'] },
  ...
  { id: 'n6', x: 250, y: 220, type: 'intersection', name: '美食街', connections: ['n2', 'n5', 'n7', 'n12'] },
  { id: 'n7', x: 100, y: 340, type: 'building', name: '幸福里小区', connections: ['n1', 'n6', 'n11', 'n14'] },
  { id: 'n8', x: 400, y: 220, type: 'charging', name: '充电站A', connections: ['n3', 'n9', 'n13'] },
  { id: 'n9', x: 550, y: 220, type: 'building', name: '阳光花园', connections: ['n4', 'n8', 'n18'] },
  { id: 'n10', x: 250, y: 340, type: 'intersection', name: '广场南', connections: ['n1', 'n12', 'n14'] },
  ...
  { id: 'n13', x: 400, y: 340, type: 'building', name: '金茂大厦', connections: ['n8', 'n12', 'n17'] },
  { id: 'n14', x: 400, y: 460, type: 'intersection', name: '南门', connections: ['n7', 'n10', 'n15', 'n17'] },
  { id: 'n15', x: 100, y: 580, type: 'building', name: '老旧社区', connections: ['n11', 'n14', 'n19'] },
  ...
  { id: 'n20', x: 250, y: 700, type: 'building', name: '惠民小区', connections: ['n16', 'n19', 'n21'] },
  { id: 'n21', x: 400, y: 700, type: 'building', name: '中心医院', connections: ['n17', 'n20', 'n22'] },
...
export const findShortestPath = (startId: string, endId: string): string[] => {
  ...
  while (unvisited.size > 0) {
    ...
    for (const neighborId of currentNode.connections) {
      ...
      const alt = (distances.get(minNode) || 0) + calculateDistance(currentNode, neighbor);
